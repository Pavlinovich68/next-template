    ...
    return (
        <React.Fragment>
            <Head>
                ...
                <title>{$app_variables.TITLE}</title>
                <meta charSet="UTF-8" />
                <meta name="description" content={$app_variables.APP_NAME} />
                <meta name="robots" content="index, follow" />
                <meta name="viewport" content="initial-scale=1, width=device-width" />
                <meta property="og:type" content="website"></meta>
                <meta property="og:title" content={$app_variables.TITLE}></meta>
                <meta property="og:url" content={$app_variables.URL}></meta>
                <meta property="og:description" content={$app_variables.APP_NAME} />
                <meta property="og:image" content={$app_variables.APP_NAME}></meta>
